...
-- AddForeignKey
ALTER TABLE "atendimentos" ADD CONSTRAINT "atendimentos_alternativaId_fkey" FOREIGN KEY ("alternativaId") REFERENCES "alternativas"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "atendimentos" ADD CONSTRAINT "atendimentos_questionarioId_fkey" FOREIGN KEY ("questionarioId") REFERENCES "questionarios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
